...
import edu.buffalo.cse.blueseal.networkflow.interprocedural.NetworkFlowSootMethodFilter;
...
public class CgTransformer extends SceneTransformer {
	...
	static Logger logger = Logger.getLogger(CgTransformer.class);
    ...
    public void setApkLoc(String newApkLoc){
    	apkLoc = newApkLoc;
    }
...
//
//        List<NetworkFlowMethodAnalysis> nfma = inter.getNfma();
//        for (NetworkFlowMethodAnalysis networkFlowMethodAnalysis : nfma) {
//        	if(networkFlowMethodAnalysis.getDetectedUrls().size() > 0){
//    			for (String url : networkFlowMethodAnalysis.getDetectedUrls()) {
//					logger.debug("Detected URL is: " + url);
//				}
//        		logger.debug(networkFlowMethodAnalysis.getSootMethod().toString());
//            	
//    			if(networkFlowMethodAnalysis.isIntraProcedural()){
//    				logger.debug(" have intra");
//    			}
//    			if(networkFlowMethodAnalysis.isInterProcedural()){
//    				logger.debug(" have inter");				
//    			}
//        		
//        	}
//			
...
//    }
    ...
    private List<SootMethod> getDynamicEntryPoints(List<SootMethod> initialEntryPoints) {
        ...
        logger.debug("Transforming file: " + apkLoc);
